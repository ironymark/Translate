 ...
 * @author Doug Felt
 */
public abstract class BidiCharmap {

    /** Charmap instance that maps portions of ASCII to strong format codes. */
    public static final BidiCharmap ARABIC = new translationArabic();

    public static final BidiCharmap TEST_ENGLISH = new TestEnglish();

    /** Charmap instance that maps portions of ASCII to AL, AN. */
    public static final BidiCharmap TEST_MIXED = new TestMixed();

    /** Charmap instance that maps portions of ASCII to R. */
    public static final BidiCharmap TEST_HEBREW = new TestHebrew();

    /** Charmap instance that maps portions of ASCII to AL, AN, R. */
    public static final BidiCharmap TEST_ARABIC = new TestArabic();
     ...
     */
    public static class DefaultCharmap extends BidiCharmap {
	 ...
	 */
        ...
        protected static final byte[] arabicMap =
        ...
        NSM, NSM, NSM, NSM, NSM, NSM, NSM, NSM, AL, AL, AL, AL,
        AL, AL, AL, AL, AL, AL, AN, AN, AN, AN, AN, AN, AN,
        AN, AN, AN, ET, AN, AN, AL, AL, AL, AL, AL, AL, AL,
        AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL,
        AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL,
        AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL,
        AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL, AL,
	 ...
	 */
        public void convert(char[] chars, int charStart, byte[] codes, int codeStart, int count) {
            for (int i = 0; i < count; ++i) {
                ...
                else if (theChar > 0xfe00)
                    codes[codeStart + i] = AL;
               else
                    codes[codeStart + i] = L;
            }
        }
